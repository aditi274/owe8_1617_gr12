...
class NcbipsiblastCommandline(_Ncbiblast2SeqCommandline):
    ...
    def __init__(self, cmd="psiblast", **kwargs):
        self.parameters = [
            ...
            _Option(["-in_msa", "in_msa"],
                    ...
                    filename=True,
                    equate=False),
            _Option(["-msa_main_idx", "msa_main_idx"],
                    """Index of sequence to use as main in MSA.

                    Index (1-based) of sequence to use as the main in the
            ...
            _Option(["-inclusion_ethresh", "inclusion_ethresh"],
                    ...
                    equate=False),
            _Switch(["-ignore_msa_main", "ignore_msa_main"],
                    """Ignore the main sequence when creating PSSM

                    Requires: in_msa
                    Incompatible with: msa_main_idx, in_pssm, query, query_loc, phi_pattern
                    """),
            # PHI-BLAST options:
    ...
    def _validate(self):
        incompatibles = {"num_iterations": ["remote"],
                         ...
                         "ignore_msa_main": ["msa_main_idx", "in_pssm",
